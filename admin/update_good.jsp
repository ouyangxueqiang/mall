...
<div class="container-fluid">
	...
	<br>
	<form class="form-horizontal" action="updateGood" method="post"  enctype="multipart/form-data">
	
		<input type="hidden" class="form-control" id="input_pass" name="id" required="required" value = "${goodList.id}">
		<div class="form-group">
			<label for="input_pass" class="col-sm-1 control-label">商品名称</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" id="input_pass" name="name" required="required" value = "${goodList.name}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<input type="text" class="form-control" id="input_pass" name="cover" required="required"  value = "${goodList.cover}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<input type="text" class="form-control" id="input_pass" name="image1" required="required" value = "${goodList.image1}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<input type="text" class="form-control" id="input_pass" name="image2" required="required" value = "${goodList.image2}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="input_pass" name="price" required="required" value = "${goodList.price}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="input_pass" name="intro" required="required" value = "${goodList.intro}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="input_pass" name="stock" required="required" value = "${goodList.stock}">
			</div>
		</div>
